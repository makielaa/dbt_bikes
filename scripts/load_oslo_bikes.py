...
Dwa tryby:
  ...
  python load_oslo_bikes.py              # ładuje wszystkie zaległe miesiące aż do bieżącego (tryb automatyczny)
"""
...
# ── Tryb automatyczny (dogania cały backlog) ──────────────────────────────────
...
def run_monthly(conn):
    ...
    while True:
        ...
        try:
            ...
            sys.exit(1)  # bez tego GitHub Actions pokazuje "sukces" mimo błędu
